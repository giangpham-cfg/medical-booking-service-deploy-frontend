...
class ManageDoctor extends Component {
    ...
    handleChangeSelectDoctorInfo = async (selectedOption, name) => {
        ...
        // console.log("check name: ", selectedOption, name)
        this.setState({
            ...stateCopy
        })
    }
    ...
    render() {
        ...
        // console.log('check state with Giang: ', this.state)
        return (
            <div className='manage-doctor-container'>
                ...
                <div className='row'>
                    <div className='col-4 form-group'>
                        <label><FormattedMessage id="specialty.select-specialty" /></label>
                        <Select
                            value={this.state.selectedSpecialty}
                            onChange={this.handleChangeSelectDoctorInfo}
                            options={listSpecialty}
                            placeholder={<FormattedMessage id="specialty.select-specialty" />}
